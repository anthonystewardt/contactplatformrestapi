...
namespace contactplatformweb.Migrations
{
    ...
    [Migration("20240707164215_AddIsPostulateToUser")]
    partial class AddIsPostulateToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("contactplatformweb.Entities.Capa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("contactplatformweb.Entities.Cese", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("contactplatformweb.Entities.Supervisor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("contactplatformweb.Entities.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ReasonDepartureId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("contactplatformweb.Entities.Trainer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("contactplatformweb.Entities.User", b =>
                {
                    ...
                    b.Property<bool?>("HasCese")
                        .HasColumnType("bit");

                    b.Property<string>("Ip")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("IsPostulate")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("contactplatformweb.Entities.Team", b =>
                {
                    ...
                    b.HasOne("contactplatformweb.Entities.User", "Supervisor")
                        .WithMany()
            ...
            modelBuilder.Entity("contactplatformweb.Entities.User", b =>
                {
                    ...
                    b.HasOne("contactplatformweb.Entities.Capa", null)
                        .WithMany("Users")
                    ...
                    b.HasOne("contactplatformweb.Entities.Modality", "Modality")
                        .WithMany()
                    ...
                    b.HasOne("contactplatformweb.Entities.Team", null)
                        .WithMany("Users")
